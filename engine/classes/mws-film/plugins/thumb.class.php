...
class thumbnail {
	...
	function insert_watermark($min_image) {
		...
		$this->watermark_image_light = ROOT_DIR . '/templates/' . $config['skin'] . '/forum/images/watermark_light.png';
		$this->watermark_image_dark = ROOT_DIR . '/templates/' . $config['skin'] . '/forum/images/watermark_dark.png';
