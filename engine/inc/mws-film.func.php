...
//$tclist =array();
	$control = ( in_array( $check, array($tclist) ) ) ? "<input type=\"checkbox\" class=\"switch\" size=\"10\" name=\"save[tclist][]\" value=\"{$check}\" checked />&nbsp;" : "<input type=\"checkbox\" name=\"save[tclist][]\" value=\"{$check}\" />&nbsp;";
