...
<thead>
    <tr>
        ...
        <td>{$lng_inc['126']}</td>
        <td width="10"><a href="#" onclick="ShowAlert('{$lang['p_info']}', '{$lng_inc['135']}');return false;"><i class="icon-info-sign"></i></a>&nbsp;&nbsp;{$lng_inc['125']}</td>
        <td>{$lng_inc['126']}</td>
...
HTML;
    ...
    showXFRow(
        ...
        makeDropDown($xfields,"save[film_season]", $mws_film['film_season'], True),
        "season"
    );
    showXFRow(
        $lng_inc['17'],
        $lng_inc['17'].$lng_inc['19'],
        makeDropDown($xfields,"save[film_episode]", $mws_film['film_episode'], True),
        "episode"
    );
    showXFRow(
        $lng_inc['15'],
    ...
    showXFRow(
        ...
        makeDropDown($xfields,"save[film_created_by]", $mws_film['film_created_by'], True),
        "created_by"
    );
    showXFRow(
        $lng_inc['18'],
    ...
    showXFRow(
        ...
        makeDropDown($xfields,"save[film_revenue]", $mws_film['film_revenue'], True),
        "revenue"
    );
    showXFRow(
        $lng_inc['47'],
