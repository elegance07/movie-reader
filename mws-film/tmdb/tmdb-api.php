...
require ("data/Company.php");
require ("data/Episode.php");
require ("data/Genre.php");
require ("data/Movie.php");
require ("data/Person.php");
require ("data/Role.php");
require ("data/Season.php");
require ("data/TVShow.php");
/*require ("roles/MovieRole.php");
require ("roles/TVShowRole.php");*/
require ("config/APIConfiguration.php");
...
class TMDB {
	...
	public function __construct($config = null) {
		...
		if (! $this->_loadConfig()){
			echo _("Impossible de lire la configuration, vérifiez que la clé API est valide");
			exit;
		}
	}
	 ...
	 */
	public function setTimeZone($timezone = 'Europe/Paris') {
	...
	private function _call($action, $appendToResponse = '') {
		...
		if ($this->getConfig()->getDebug()) {
			echo '<pre><a href="' . $url . '" target="blank_">vérifier la requête</a></pre>';
		}
